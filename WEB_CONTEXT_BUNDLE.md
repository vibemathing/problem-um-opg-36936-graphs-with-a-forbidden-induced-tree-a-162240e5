...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-36936"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-v1",
      "problem_contract_sha256": "d6ca7ae8609d80e0ccaa526c947fb17de8bfa0eda228d6d5199ec21237c9a323",
      "problem_id": "problem:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5",
      "route_id": "route:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-source-fidelity-01",
      "graph_id": "graph:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Say that a family ${\\mathcal F}$ of graphs is $\\chi$-bounded if there exists a function $f: {\\mathbb N} \\rightarrow {\\mathbb N}$ so that every $G \\in {\\mathcal F}$ satisfies $\\chi(G) \\le f (\\omega(G))$. Conjecture For every fixed tree $T$, the family of graphs with no induced subgraph isomorphic to $T$ is $\\chi$-bounded."
          },
          "statement_sha256": "c0d4fc2299c58a91fa7cbcf5da2acebd0c4ebb8d5045e97309954935bcd1c9c5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-root",
      "route_id": "route:um-opg-36936-graphs-with-a-forbidden-induced-tree-a-162240e5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-36936-4973e4bf95e9",
        "url": "https://www.unsolvedmath.com/problems/OPG-36936"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
